  ...
  return (
    <div className="bg-linear-to-b from-[#F2E9DB] to-[#DFC8A5] flex flex-col items-center justify-center gap-y-10 py-16">
      ...
      <div className="grid min-[700px]:grid-cols-6 gap-x-4 gap-y-4">
        ...
        <div className="col-span-2 p-1 rounded-2xl border max-[700px]:h-72 border-white  bg-linear-to-t from-20% from-[rgba(194,137,120,0.5)]  via-70% via-[rgba(255,255,255,0.1)] to-100% to-[rgba(255,255,255,0.4)]">
